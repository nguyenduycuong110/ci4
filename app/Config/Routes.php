...
$routes->get(HTSEARCH.HTSUFFIX, 'Frontend\Search\Search::index');
// $routes->get(HTSEARCH.'/trang-([0-9]+)'.HTSUFFIX, 'Frontend\Search\Router::search/$1/$2');
// $routes->get(HTSEARCH.'/trang-([0-9]+)/([a-zA-Z0-9-]+)'.HTSUFFIX, 'Frontend\Search\Router::search/$1/$2/$3');
// dd(HTSEARCH);
