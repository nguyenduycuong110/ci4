...
if (! function_exists('directional_cart_btn')){
    function directional_cart_btn($id = ''){
        $html = '';
        $html = $html .'<div class="button_actions uk-clearfix">';
            $html = $html .'<button type="submit" data-redirect="1" class="btn-tv add-cart" data-sku="SKU_'.$id.'">';
                $html = $html .'<span class="text_1"> Đặt mua</span>';
            $html = $html .'</button>';
        $html = $html .'</div>';
        return $html;
    }
