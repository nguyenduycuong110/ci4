...
class Catalogue extends FrontendController{
    ...
    public function index($id = 0, $page = 1){
        ...
        $detailCatalogue = $this->AutoloadModel->_get_where([
            'select' => ' tb1.id,tb1.lft, tb1.rgt, tb1.level, tb1.parentid, tb1.image,  tb2.title, tb2.canonical,  tb2.content, tb2.description, tb2.meta_title, tb2.meta_description, tb1.album, tb1.file, tb1.icon',
