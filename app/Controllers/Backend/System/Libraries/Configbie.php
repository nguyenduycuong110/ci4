	...
	public function system(){
		$data['homepage'] =  array(
			...
			'value' => array(
				...
				'general' => array('type' => 'editor', 'label' => 'Thông tin chung'),
			),
		);
		$data['intro'] =  array(
			...
			'value' => array(
				...
				'description' => array('type' => 'editor', 'label' => 'Nội dung'),
				'product' => array('type' => 'editor', 'label' => 'Nội dung SP'),
			),
		);
		$data['contact'] =  array(
      ...
      $data['contact_1'] =  array(
			...
			'description' => 'Cấu hình đầy đủ thông tin liên hệ giúp khách hàng dễ dàng tiếp cận với dịch vụ của bạn',
			'value' => array(
				'bac' => array('type' => 'text', 'label' => 'Địa chỉ miền bắc'),
				'trung' => array('type' => 'text', 'label' => 'Địa chỉ miền trung'),
				'nam' => array('type' => 'text', 'label' => 'Địa chỉ miền nam'),
			),
		);
		$data['payment'] =  array(
			'label' => 'Thanh Toán',
			'description' => 'Cấu hình đầy đủ thông tin liên hệ giúp khách hàng dễ dàng tiếp cận với dịch vụ của bạn',
			'value' => array(
				'bank' => array('type' => 'editor', 'label' => 'Bank'),
			),
		);
		$data['banner'] =  array(
			'label' => 'Cấu hình khác',
		...
		$data['social'] =  array(
			...
			'value' => array(
				...
				'iframe_fanpage_fb' => array('type' => 'textarea', 'label' => 'Fanpage Facebook'),
				'iframe_chat_live' => array('type' => 'textarea', 'label' => 'Mã nhúng iframe chat live Facebook'),
